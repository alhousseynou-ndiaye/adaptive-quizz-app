...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSTATS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERSTATS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERSTATS actions', async () => {
      const arg = { id: 204 };
    ...
    it('dispatches UPDATE_USERSTATS actions', async () => {
      const arg = { id: 204 };
    ...
    it('dispatches PARTIAL_UPDATE_USERSTATS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERSTATS actions', async () => {
      const arg = 42666;
