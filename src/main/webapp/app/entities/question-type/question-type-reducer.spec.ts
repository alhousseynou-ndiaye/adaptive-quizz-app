...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTIONTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTIONTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTIONTYPE actions', async () => {
      const arg = { id: 28478 };
    ...
    it('dispatches UPDATE_QUESTIONTYPE actions', async () => {
      const arg = { id: 28478 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTIONTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTIONTYPE actions', async () => {
      const arg = 42666;
