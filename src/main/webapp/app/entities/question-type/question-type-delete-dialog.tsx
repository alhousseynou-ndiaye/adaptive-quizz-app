...
import { deleteEntity, getEntity } from './question-type.reducer';

export const QuestionTypeDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(questionTypeEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adaptiveQuizzApp.questionType.delete.question">
        <Translate contentKey="adaptiveQuizzApp.questionType.delete.question" interpolate={{ id: questionTypeEntity.id }}>
...
export default QuestionTypeDeleteDialog;
