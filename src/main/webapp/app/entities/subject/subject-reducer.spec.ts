...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './subject.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUBJECT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUBJECT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUBJECT actions', async () => {
      const arg = { id: 11747 };
    ...
    it('dispatches UPDATE_SUBJECT actions', async () => {
      const arg = { id: 11747 };
    ...
    it('dispatches PARTIAL_UPDATE_SUBJECT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUBJECT actions', async () => {
      const arg = 42666;
