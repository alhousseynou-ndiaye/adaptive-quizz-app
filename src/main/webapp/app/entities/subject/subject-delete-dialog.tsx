...
import { deleteEntity, getEntity } from './subject.reducer';
...
export const SubjectDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="adaptiveQuizzApp.subject.delete.question">
        <Translate contentKey="adaptiveQuizzApp.subject.delete.question" interpolate={{ id: subjectEntity.id }}>
