...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWREMINDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REVIEWREMINDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REVIEWREMINDER actions', async () => {
      const arg = { id: 14856 };
    ...
    it('dispatches UPDATE_REVIEWREMINDER actions', async () => {
      const arg = { id: 14856 };
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWREMINDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REVIEWREMINDER actions', async () => {
      const arg = 42666;
